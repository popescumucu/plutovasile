...
MethodInstance for Main.workspace#4.double(::Dict{Symbol, AbstractFloat}, ::Symbol)
  from double(mapping, key::Symbol) in Main.workspace#4 at /home/runner/work/plutovasile/plutovasile/tutorials/benchmarking.jl#==#3f0e2049-8597-4dac-b499-4d7a8a35978e:1
Arguments
...
BenchmarkTools.Trial: 10000 samples with 991 evaluations.
 Range (min … max):   39.859 ns … 24.291 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):      41.978 ns              ┊ GC (median):    0.00%
 Time  (mean ± σ):   118.739 ns ±  1.042 μs  ┊ GC (mean ± σ):  1.56% ± 1.69%

       █▄▅                                                      
  ▂▃▄▄▇████▄▃▂▂▂▂▂▃▃▄▄▃▃▃▂▃▃▂▂▃▄▄▅▄▃▄▃▃▃▃▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▁▂▂ ▃
  39.9 ns         Histogram: frequency by time         56.2 ns <
...
BenchmarkTools.Trial: 10000 samples with 997 evaluations.
 Range (min … max):  22.969 ns …  12.103 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):     24.373 ns               ┊ GC (median):    0.00%
 Time  (mean ± σ):   56.491 ns ± 497.924 ns  ┊ GC (mean ± σ):  0.67% ± 1.38%

   ▁▁▄▆▇▇█▇▆▄▁       ▁▁▂▂▂▁▂▂▁▁▁        ▂▃▃▃▁▂▂▂▂ ▂▁           ▂
  ▆███████████▇▆▇▆▇█▇██████████████▇▅▆▄█████████████████▆▆▆▆▆▅ █
  23 ns         Histogram: log(frequency) by time        34 ns <
